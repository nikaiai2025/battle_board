...
## 対象BDDシナリオ
- `features/phase2/ai_accusation.feature` — 全10シナリオ
- `features/phase2/command_system.feature` — 既存15シナリオ（phase2パス追加による回帰確認）

## 必読ドキュメント（優先度順）
1. [必須] `features/phase2/ai_accusation.feature` — 対象シナリオ
2. [必須] `features/phase2/command_system.feature` — 既存コマンドシナリオ（回帰確認）
...
3. cucumber.js 設定変更
   - paths に `features/phase2/command_system.feature`, `features/phase2/ai_accusation.feature` 追加
