...
2. [必須] `features/phase2/command_system.feature` — コマンドシステムBDDシナリオ
3. [必須] `features/phase2/ai_accusation.feature` — AI告発BDDシナリオ
4. [必須] `features/phase1/admin.feature` — 管理者機能BDDシナリオ（GAP-2関連）
5. [必須] `features/phase1/mypage.feature` — マイページBDDシナリオ
