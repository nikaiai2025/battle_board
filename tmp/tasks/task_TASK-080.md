...
## 対象BDDシナリオ
- `features/phase2/ai_accusation.feature` — 全シナリオ（BOTマーク2件はcucumber.js除外のまま）
- `features/phase2/command_system.feature` — 回帰確認
...
以下の内容で `features/phase2/ai_accusation.feature` を上書きすること（人間承認済み）:
...
### 1. `features/phase2/ai_accusation.feature`
...
ESC-TASK-080-1 解決: 選択肢Aを採用（人間承認済み）。`features/phase2/command_system.feature` を locked_files に追加し、以下の修正を行うこと:
- Background DataTable: `| !tell | 50 |` → `| !tell | 10 |`
