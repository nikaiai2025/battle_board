...
**Sprint-54 完了 — 荒らし役BOT本番稼働基盤（Internal API + cron）**

HUMAN-001確定（TDR-010）を受けて、BOT本番稼働に必要なバックエンド全体を実装。DBマイグレーション・BotService next_post_at対応・Internal APIルート3本・Bearer認証・GitHub Actionsワークフロー2本。
...
- vitest: 52ファイル / 1240テスト / 全PASS（Sprint-54で+39件: Internal API認証・BOTスケジューリング・APIルートテスト追加）
