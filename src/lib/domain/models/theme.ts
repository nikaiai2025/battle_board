...
export const FONT_CATALOG: readonly FontEntry[] = [
	...
	},
	{
		id: "meiryo",
		name: "メイリオ",
		cssFontFamily: "'Meiryo', 'Hiragino Kaku Gothic ProN', sans-serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		id: "bizud-gothic",
		name: "BIZ UDゴシック",
		cssFontFamily: "'BIZ UDGothic', 'Meiryo', sans-serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		id: "bizud-mincho",
		name: "BIZ UD明朝",
		cssFontFamily: "'BIZ UDMincho', 'Yu Mincho', serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		id: "ms-gothic",
		name: "MS ゴシック",
		cssFontFamily: "'MS Gothic', 'Hiragino Kaku Gothic ProN', sans-serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		...
		name: "ヒラギノ丸ゴ",
		cssFontFamily:
			"'Hiragino Maru Gothic ProN', 'M PLUS Rounded 1c', 'Meiryo', sans-serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	...
	},
	{
		id: "georgia",
		name: "Georgia",
		cssFontFamily: "'Georgia', 'Yu Mincho', serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		id: "segoe-ui",
		name: "Segoe UI",
		cssFontFamily: "'Segoe UI', 'Hiragino Kaku Gothic ProN', sans-serif",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		id: "consolas",
		name: "Consolas",
		cssFontFamily: "'Consolas', 'Menlo', 'Courier New', monospace",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
	{
		id: "comic-sans",
		name: "Comic Sans MS",
		cssFontFamily: "'Comic Sans MS', 'Hiragino Maru Gothic ProN', cursive",
		isFree: true,
		category: "system",
		googleFontFamily: null,
	},
